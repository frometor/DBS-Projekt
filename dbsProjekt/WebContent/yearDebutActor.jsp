...
<title>year and debut form actor</title>
</head>
...
<body>
	...
	<%
		...
		String theX = request.getParameter("act_name").toString();

		ResultSet rs = test.yearAndMovieDebutActor(theX);
	%>
	<div class="container">
		<div class="jumbotron">
			<p>debut Year and Movie from actor X</p>
